export class DialogModel {
    ...
    btnToggleModal() {
        [this.modal, this.fade].forEach((el) => el === null || el === void 0 ? void 0 : el.classList.toggle("hide"));
    }
    togleModal() {
        [this.openModal, this.closeModal, this.fade].forEach((el) => {
            ...
            el === null || el === void 0 ? void 0 : el.addEventListener('click', () => this.btnToggleModal());
            dialogUnavailable === null || dialogUnavailable === void 0 ? void 0 : dialogUnavailable.focus();
            document.addEventListener('keyup', (tecla) => {
                var _a;
                if (tecla.key == 'Escape' && !((_a = this.modal) === null || _a === void 0 ? void 0 : _a.classList.contains('hide'))) {
                    this.btnToggleModal();
                }
            });
        });
